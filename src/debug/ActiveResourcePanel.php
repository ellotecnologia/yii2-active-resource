<?php namespace Zaioll\ActiveResource\debug;
 ...
 * @since 2.0
 */
class ActiveResourcePanel extends Panel
{
    /**
    ...
    private $_models;
    /**
     * @var \Zaioll\ActiveResource\http\client\ClientInterface|array|string
     */
    private $_httpClient = 'Zaioll\ActiveResource\http\Cliente';
    ...
    /**
     * @return \Zaioll\ActiveResource\http\client\ClientInterface
     * @throws \yii\base\InvalidConfigException
     */
    public function getHttpClient()
    {
        if (! is_object($this->_httpClient)) {
            $this->_httpClient = Instance::ensure($this->_httpClient, Cliente::class);
        }
    ...
    public function init()
    {
        $this->actions['request-execute'] = [
            'class' => 'Zaioll\ActiveResource\client\debug\RequestExecuteAction',
            'panel' => $this,
        ];
    }
    ...
    {
        return 'Active Resource HTTP Client';
    }
    ...
    public function getSummary()
    {
        ...
        //return Yii::$app->view->render(__DIR__ . '/views/summary', [
    ...
    public function getDetail()
    {
        ...
        //return Yii::$app->view->render(__DIR__ . '/views/detail', [
